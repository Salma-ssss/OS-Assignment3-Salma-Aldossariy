...
class SharedResources {
    ...
    // Added ReentrantLock for protecting shared resources
    ...
    public static void incrementCompletedProcess() {
        // TODO: Protect this critical section with a lock
        // Added synchronization for completedProcessCount
        lock.lock();
        try {
    ...
    public static void addWaitingTime(long time) {
        // TODO: Protect this critical section with a lock
        // Added synchronization for totalWaitingTime
        lock.lock();
        try {
    ...
    public static void logExecution(String message) {
        ...
        // Added synchronization executionLog
        lock.lock();
        try {
...
public class SchedulerSimulationSync {
    public static void main(String[] args) {
        ...
        int studentID = 445052168; // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
